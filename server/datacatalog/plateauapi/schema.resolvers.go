...
// Datasets is the resolver for the datasets field.
func (r *globalAreaResolver) Datasets(ctx context.Context, obj *GlobalArea, input *DatasetsInput) ([]Dataset, error) {
	if input == nil {
		input = &DatasetsInput{}
	}
	// Only return datasets with "global" type
	input.IncludeTypes = []string{"global"}
	return r.Repo.Datasets(ctx, input)
}

// Parent is the resolver for the parent field.
func (r *globalAreaResolver) Parent(ctx context.Context, obj *GlobalArea) (Area, error) {
	// GlobalArea has no parent
	return nil, nil
}

// Children is the resolver for the children field.
func (r *globalAreaResolver) Children(ctx context.Context, obj *GlobalArea) ([]Area, error) {
	// GlobalArea has no children
	return []Area{}, nil
}
...
// GlobalArea returns GlobalAreaResolver implementation.
func (r *Resolver) GlobalArea() GlobalAreaResolver { return &globalAreaResolver{r} }
...
type globalAreaResolver struct{ *Resolver }
