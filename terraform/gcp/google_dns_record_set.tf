...
resource "google_dns_record_set" "plateauview_tile_acme_challenge_cname" {
  project = data.google_project.project.project_id

  name         = google_certificate_manager_dns_authorization.plateauview_tile.dns_resource_record[0].name
  managed_zone = google_dns_managed_zone.zone.name
  rrdatas      = [google_certificate_manager_dns_authorization.plateauview_tile.dns_resource_record[0].data]
  type         = google_certificate_manager_dns_authorization.plateauview_tile.dns_resource_record[0].type
  ttl          = 300
}
...
resource "google_dns_record_set" "plateauview_tile" {
  project = data.google_project.project.project_id
  ...
  managed_zone = google_dns_managed_zone.zone.name
  rrdatas      = [google_compute_global_address.plateauview_tile.address]
}
